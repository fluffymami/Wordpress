...
class Zakra_Meta_Box_Page_Settings {
	...
	public static function render( $post ) {
		...
		$zakra_menu_item_color = isset( $zakra_menu_item_color[0] ) ? $zakra_menu_item_color[0] : '#16181a';

		$zakra_menu_item_hover_color = get_post_meta( get_the_ID(), 'zakra_menu_item_hover_color' );
		$zakra_menu_item_hover_color = isset( $zakra_menu_item_hover_color[0] ) ? $zakra_menu_item_hover_color[0] : '#269bd1';

		$zakra_menu_item_active_color = get_post_meta( get_the_ID(), 'zakra_menu_item_active_color' );
		$zakra_menu_item_active_color = isset( $zakra_menu_item_active_color[0] ) ? $zakra_menu_item_active_color[0] : '#269bd1';
			...
			<div class="zakra-ui-content">
					...
					<div class="options-group">
						...
						<div class="zakra-ui-field">
							<label class="tg-label">
								<input type="radio" name="zakra_layout" value="tg-site-layout--customizer" <?php checked( $zakra_layout, 'tg-site-layout--customizer' ); ?> />
								<img src="<?php echo esc_url( ZAKRA_PARENT_URI . '/assets/img/icons/customizer.png' ); ?>" />
							</label>
							<label class="tg-label">
								<input type="radio" name="zakra_layout" value="tg-site-layout--default" <?php checked( $zakra_layout, 'tg-site-layout--default' ); ?> />
								<img src="<?php echo esc_url( ZAKRA_PARENT_URI . '/assets/img/icons/layout-default.png' ); ?>" />
							</label>
							<label class="tg-label">
								<input type="radio" name="zakra_layout" value="tg-site-layout--left" <?php checked( $zakra_layout, 'tg-site-layout--left' ); ?> />
								<img src="<?php echo esc_url( ZAKRA_PARENT_URI . '/assets/img/icons/left-sidebar.png' ); ?>" />
							</label>
							<label class="tg-label">
								<input type="radio" name="zakra_layout" value="tg-site-layout--right" <?php checked( $zakra_layout, 'tg-site-layout--right' ); ?> />
								<img src="<?php echo esc_url( ZAKRA_PARENT_URI . '/assets/img/icons/right-sidebar.png' ); ?>" />
							</label>
							<label class="tg-label">
								<input type="radio" name="zakra_layout" value="tg-site-layout--no-sidebar" <?php checked( $zakra_layout, 'tg-site-layout--no-sidebar' ); ?> />
								<img src="<?php echo esc_url( ZAKRA_PARENT_URI . '/assets/img/icons/full-width.png' ); ?>" />
							</label>
						</div>
					</div>
					...
					<div class="options-group">
						...
						<div class="zakra-ui-field">
							...
							<label class="tg-label">
								...
								<img src="<?php echo esc_url( ZAKRA_PARENT_URI . '/assets/img/icons/header-left.png' ); ?>"
								     title="Header Left" />
							</label>
							<label class="tg-label">
								<input type="radio" name="zakra_header_style"
								       value="tg-site-header--center" <?php checked( $zakra_header_style, 'tg-site-header--center' ); ?> />
								<img src="<?php echo esc_url( ZAKRA_PARENT_URI . '/assets/img/icons/header-center.png' ); ?>"
								     title="Header Center" />
							</label>
							<label class="tg-label">
								<input type="radio" name="zakra_header_style"
								       value="tg-site-header--right" <?php checked( $zakra_header_style, 'tg-site-header--right' ); ?> />
								<img src="<?php echo esc_url( ZAKRA_PARENT_URI . '/assets/img/icons/header-right.png' ); ?>"
								     title="Header Right" />
							</label>
						</div>
					</div>
				...
				<div id="page-settings-primary-menu">
					...
					<div class="options-group">
						...
						<div class="zakra-ui-field">
							<input class="tg-color-picker" type="text" name="zakra_menu_item_color"
							       ...
							       value="<?php echo esc_attr( $zakra_menu_item_color ); ?>" data-default-color="#16181a" />
						</div>
					</div>
					...
					<div class="options-group">
						...
						<div class="zakra-ui-field">
							<input class="tg-color-picker" type="text" name="zakra_menu_item_hover_color"
							       ...
							       value="<?php echo esc_attr( $zakra_menu_item_hover_color ); ?>" data-default-color="#269bd1" />
						</div>
					</div>
					...
					<div class="options-group">
						...
						<div class="zakra-ui-field">
							<input class="tg-color-picker" type="text" name="zakra_menu_item_active_color" id="zakra-menu-item-active-color" value="<?php echo esc_attr( $zakra_menu_item_active_color ); ?>" data-default-color="#269bd1" />
						</div>
					</div>
	...
	public static function save( $post_id ) {
		...
		$menu_item_color        = isset( $_POST['zakra_menu_item_color'] ) ? sanitize_hex_color( wp_unslash( $_POST['zakra_menu_item_color'] ) ) : '#16181a'; // WPCS: CSRF ok.
		$menu_item_hover_color  = isset( $_POST['zakra_menu_item_hover_color'] ) ? sanitize_hex_color( wp_unslash( $_POST['zakra_menu_item_hover_color'] ) ) : ''; // WPCS: CSRF ok.
		$menu_item_active_color = isset( $_POST['zakra_menu_item_active_color'] ) ? sanitize_hex_color( wp_unslash( $_POST['zakra_menu_item_active_color'] ) ) : ''; // WPCS: CSRF ok.
		...
		// MENU ITEM HOVER COLOR.
		if ( '#269bd1' !== $menu_item_hover_color ) {
		...
		// MENU ITEM ACTIVE COLOR.
		if ( '#269bd1' !== $menu_item_active_color ) {
